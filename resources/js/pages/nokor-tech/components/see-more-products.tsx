        ...
        <div className="rainbow-button rounded-full transition-all duration-300 hover:rounded-[16px]">
            <div className="bg-background/50 rounded-full p-1 transition-all duration-300 hover:rounded-[16px]">
                ...
                >
                    ...
                    {/* Circle */}
                    <span className="dark:bg-true-primary absolute top-1/2 left-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-[50%] bg-[#111111] opacity-0 transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:h-[220px] group-hover:w-[440px] group-hover:opacity-100"></span>
